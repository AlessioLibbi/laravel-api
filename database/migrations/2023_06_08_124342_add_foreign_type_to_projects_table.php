...
return new class extends Migration
{
    ...
    {
        Schema::table('projects', function (Blueprint $table) {
            $table->dropForeign('projects_type_id_foreign'); // si scrive il nome della tabella principale +  + il nome della colonna + _ + foreign e significa che si cancella la chiave esterna
